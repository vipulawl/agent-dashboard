#!/usr/bin/env python3
"""
Agent Dashboard — self-hosted observability for agentic flows.

Usage:
  python main.py serve                          # localhost:7777, new DB
  python main.py serve --db ~/path/to/agent.db # point at existing DB
...
def main():
    ...
    srv.add_argument("--db", default="agent_dashboard.db",
                     help="SQLite database path (default: agent_dashboard.db in cwd)")
